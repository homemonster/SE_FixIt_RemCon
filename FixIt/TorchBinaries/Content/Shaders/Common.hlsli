...
#define RANDOM_SLOT 29

// srvs lighting
#define SKYBOX_SLOT 10
#define SKYBOX_IBL_CLOSE_SLOT 11
#define SKYBOX_IBL_FAR_SLOT 17
#define AO_SLOT 12
...
#define LBUFFER_SLOT 18
#define DEPTHBUFFER_SLOT 21
...
#define COMPLEMENTARY_DEPTH
	...
	bool IsDepthForeground(float x) { return x < 1; }
...
static const float3 CASCADE_DEBUG_COLORS[MAX_SHADOW_CASCADES] = 
{
    float3(1, 0, 0),
    float3(0, 1, 0),
    float3(0, 0, 1),
