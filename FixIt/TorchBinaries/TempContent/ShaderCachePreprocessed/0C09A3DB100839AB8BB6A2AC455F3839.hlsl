...
{ 
    float relativeIndex = float ( index ) / float ( 64 - 1 ) ; 
...
{ 
    float relativeIndex = index / float ( 64 - 1 ) ; 
    float logLuminance = relativeIndex * HistogramScaleOffset . z + HistogramScaleOffset . w ; 
    return exp2 ( logLuminance ) ; 
} 
...
#line 1 "../Tonemapping/Filters.hlsli"
...
#line 2 "../Tonemapping/Filters.hlsli"
...
#line 3 "../Tonemapping/Filters.hlsli"
...
#line 4 "../Tonemapping/Filters.hlsli"


#line 1 "Postprocess/Defines.hlsli"
...
{ 
    ...
    float linear_exposure = LuminanceKeyValueCendos ( avg_lum ) / avg_lum ; 
...
#line 6 "../Tonemapping/Filters.hlsli"
