...
#line 36
    ...
    float2 tileMult = 16 * 2 / frame_ . Screen . resolution ; 
    float2 invProjMult = 1 / float2 ( frame_ . Environment . projection_matrix . _11 , frame_ . Environment . projection_matrix . _22 ) ; 
    float2 projAdd = float2 ( frame_ . Environment . projection_matrix . _31 , - frame_ . Environment . projection_matrix . _32 ) * invProjMult ; 
...
#line 99
    ...
    [ loop ] 
    for ( uint index = ThreadIndex ; index < pointlights_num ; index += 16 * 16 ) { 
        ...
        [ branch ] if ( in_frustum ) { 
            ...
            TileIndices [ frame_ . Light . tiles_num + tileIndex * 256 + listIndex ] = index ; 
        } 
    } 
