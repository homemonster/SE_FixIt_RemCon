...
#line 7 "EnvPrefiltering.hlsli"
TextureCube < float4 > ProbeTex : register ( t1 ) ; 
...
#line 15
    ...
    { 
        ...
        if ( NL > 0 ) 
        { 
            float texelSolidAngle = 4 * 3.14159265358979323846 / ( 6 * EnvProbeRes * EnvProbeRes ) ; 
            float sampleSolidAngle = 1 / ( pdf * 16 ) ; 
