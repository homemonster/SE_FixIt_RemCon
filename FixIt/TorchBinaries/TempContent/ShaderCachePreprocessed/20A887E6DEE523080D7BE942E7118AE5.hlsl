...
#line 126
    ...
    __position_object = unpack_position_and_scale ( input . position ) ; __normal = unpack_normal ( input . normal ) ; __tangent = unpack_tangent_sign ( input . tangent4 ) ; __texcoord0 = input . texcoord0 ; __packed_bone0 = input . packed_bone0 ; __packed_bone1 = input . packed_bone1 ; __packed_bone2 = input . packed_bone2 ; __packed_bone3 = input . packed_bone3 ; __packed_bone4 = input . packed_bone4 ; __packed_bone5 = input . packed_bone5 ; __packed_bone6 = input . packed_bone6 ; __packed_bone7 = input . packed_bone7 ; __cube_transformation = input . cube_transformation ; __colormask = input . colormask ; 
