...
{ 
    float4 position : POSITION0 ; uint2 normal : NORMAL0 ; float4 tangent4 : TANGENT0 ; float2 texcoord0 : TEXCOORD0 ; float4 matrix_row0 : TEXCOORD1 ; float4 matrix_row1 : TEXCOORD2 ; float4 matrix_row2 : TEXCOORD3 ; float4 colormask : TEXCOORD4 ; 
} ; 
...
#line 126
    ...
    __position_object = unpack_position_and_scale ( input . position ) ; __normal = unpack_normal ( input . normal ) ; __tangent = unpack_tangent_sign ( input . tangent4 ) ; __texcoord0 = input . texcoord0 ; __instance_matrix = construct_matrix_43 ( input . matrix_row0 , input . matrix_row1 , input . matrix_row2 ) ; __colormask = input . colormask ; 
