...
{ 
    float gaussSum = GaussianWeight [ index + 2 ] + GaussianWeight [ index + 2 + 1 ] ; 
    float uvShift = 1 - GaussianWeight [ index + 2 ] / gaussSum ; 
...
{ 
    float gaussSum = GaussianWeight [ index + 2 ] ; 
...
{ 
    ...
    result = sample * GaussianWeight [ 2 ] ; 
