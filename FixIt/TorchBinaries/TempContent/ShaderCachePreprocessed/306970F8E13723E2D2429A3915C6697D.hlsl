...
{ 
    float4 position : POSITION0 ; float4 blend_weights : BLENDWEIGHT0 ; uint4 blend_indices : BLENDINDICES0 ; float4 packed_bone0 : TEXCOORD0 ; float4 packed_bone1 : TEXCOORD1 ; float4 packed_bone2 : TEXCOORD2 ; float4 packed_bone3 : TEXCOORD3 ; float4 packed_bone4 : TEXCOORD4 ; float4 packed_bone5 : TEXCOORD5 ; float4 packed_bone6 : TEXCOORD6 ; float4 packed_bone7 : TEXCOORD7 ; float4 cube_transformation : TEXCOORD8 ; float4 colormask : TEXCOORD9 ; 
} ; 
...
#line 126
    ...
    __position_object = unpack_position_and_scale ( input . position ) ; __blend_weights = input . blend_weights ; __blend_indices = input . blend_indices ; __packed_bone0 = input . packed_bone0 ; __packed_bone1 = input . packed_bone1 ; __packed_bone2 = input . packed_bone2 ; __packed_bone3 = input . packed_bone3 ; __packed_bone4 = input . packed_bone4 ; __packed_bone5 = input . packed_bone5 ; __packed_bone6 = input . packed_bone6 ; __packed_bone7 = input . packed_bone7 ; __cube_transformation = input . cube_transformation ; __colormask = input . colormask ; 
...
#line 12 "Geometry/Passes/VertexStage.hlsli"



#line 1 "Forward/VertexStage.hlsli"
...
#line 3 "Forward/VertexStage.hlsli"
