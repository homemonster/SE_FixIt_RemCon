...
{ 
    float gaussSum = GaussianWeight [ index + 0 ] + GaussianWeight [ index + 0 + 1 ] ; 
    float uvShift = 1 - GaussianWeight [ index + 0 ] / gaussSum ; 
...
{ 
    float gaussSum = GaussianWeight [ index + 0 ] ; 
...
{ 
    ...
    result = sample * GaussianWeight [ 0 ] ; 
