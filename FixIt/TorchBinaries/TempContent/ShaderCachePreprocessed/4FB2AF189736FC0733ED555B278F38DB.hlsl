...
{ 
    ...
    tileCoord /= 16 ; 
    uint tileIndex = mad ( frame_ . Light . tiles_x , tileCoord . y , tileCoord . x ) ; 
    
    uint numLights = min ( TileIndices [ tileIndex ] , 256 ) ; 
...
#line 33
    ...
    { 
        uint index = TileIndices [ frame_ . Light . tiles_num + mad ( 256 , tileIndex , i ) ] ; 
