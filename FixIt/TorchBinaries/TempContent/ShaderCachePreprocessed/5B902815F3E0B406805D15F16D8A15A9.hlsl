...
{ 
    float3 position : POSITION0 ; int4 material : MATERIAL0 ; uint2 normal : NORMAL0 ; int4 colorshift : COLORSHIFT0 ; 
} ; 
...
#line 126
    ...
    __position_object = unpack_voxel_position ( input . position ) ; __material_weights = unpack_voxel_weights ( input . material . w ) ; __triplanar_mat_info = input . material ; __normal = unpack_normal ( input . normal ) ; __colormask = unpack_color_shift_hsv ( input . colorshift ) ; 
...
#line 18 "Geometry/Passes/VertexStage.hlsli"



#line 1 "FoliageStreaming/VertexStage.hlsli"


#line 1 "Foliage/Foliage.hlsli"





#line 95 "Template.hlsli"


#line 95


#line 6 "Foliage/Foliage.hlsli"
...
#line 3 "FoliageStreaming/VertexStage.hlsli"
