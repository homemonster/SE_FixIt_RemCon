...
{ 
    float4 position : POSITION0 ; float2 texcoord0 : TEXCOORD0 ; float4 matrix_row0 : TEXCOORD1 ; float4 matrix_row1 : TEXCOORD2 ; float4 matrix_row2 : TEXCOORD3 ; 
} ; 
...
#line 126
    ...
    __position_object = unpack_position_and_scale ( input . position ) ; __texcoord0 = input . texcoord0 ; __instance_matrix = construct_matrix_43 ( input . matrix_row0 , input . matrix_row1 , input . matrix_row2 ) ; 
