...
static float intensityThresholds [ ] = { 1 , 10 , 50 , 100 } ; 


void __pixel_shader ( float4 position : SV_Position , float2 texcoord : TEXCOORD0 , out float4 output : SV_Target0 ) 
{ 
    float4 hdrColor = HdrTex . Sample ( LinearSampler , texcoord ) ; 
