...
{ 
    float gaussSum = GaussianWeight [ index + 8 ] + GaussianWeight [ index + 8 + 1 ] ; 
    float uvShift = 1 - GaussianWeight [ index + 8 ] / gaussSum ; 
...
{ 
    float gaussSum = GaussianWeight [ index + 8 ] ; 
...
{ 
    ...
    result = sample * GaussianWeight [ 8 ] ; 
