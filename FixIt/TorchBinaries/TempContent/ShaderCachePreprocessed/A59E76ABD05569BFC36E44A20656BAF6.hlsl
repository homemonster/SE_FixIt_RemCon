...
#line 80
    ...
    { 
        ...
        sincos ( lifetimeFactor * rotationVelocity + ( ( emitter . Flags & 0x200 ) != 0 ? 
        3.14159265358979323846 * pa . Variation : 0 ) , s , c ) ; 
...
#line 242
    float4 sample = g_ParticleTextureArray . Sample ( DefaultSampler , In . TexCoord ) ; 
...
#line 253
    ...
    DebugUniformAccumOIT ( outColor , particleDepth , In . Position . z , In . Extras . x , accumTarget , coverageTarget ) ; 
} 
