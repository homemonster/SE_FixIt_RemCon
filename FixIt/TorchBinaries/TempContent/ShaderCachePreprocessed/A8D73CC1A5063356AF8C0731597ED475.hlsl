...
float SampleShadowCascade ( float distance , float3 shadowmapPosition , float3 worldPosition , int cascadeIndex , uint2 rotationOffset = 0 , uint samplesNum = 12 ) 
{ 
...
{ 
    ...
    { 
        float resultNear = SampleShadowCascade ( distance , shadowmapPosition , worldPosition , cascadeIndex , rotationOffset , 12 / 2 ) ; 
        ...
        float resultFar = SampleShadowCascade ( distance , shadowmapPositionFar , worldPosition , cascadeIndexFar , rotationOffset , 12 / 2 ) ; 
