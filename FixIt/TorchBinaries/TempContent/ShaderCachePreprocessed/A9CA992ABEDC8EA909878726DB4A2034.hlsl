...
{ 
    float gaussSum = GaussianWeight [ index + 4 ] + GaussianWeight [ index + 4 + 1 ] ; 
    float uvShift = 1 - GaussianWeight [ index + 4 ] / gaussSum ; 
...
{ 
    float gaussSum = GaussianWeight [ index + 4 ] ; 
...
{ 
    ...
    result = sample * GaussianWeight [ 4 ] ; 
