...
{ 
    float4 position : POSITION0 ; float4 matrix_row0 : TEXCOORD0 ; float4 matrix_row1 : TEXCOORD1 ; float4 matrix_row2 : TEXCOORD2 ; 
} ; 
...
#line 126
    ...
    __position_object = unpack_position_and_scale ( input . position ) ; __instance_matrix = construct_matrix_43 ( input . matrix_row0 , input . matrix_row1 , input . matrix_row2 ) ; 
