...
{ 
    ...
    normal = normalize ( ngSample . xyz * 2 - 1 ) ; 
    gloss = ngSample . a ; 
} 
...
#line 106
    ...
    WeightedOITCendos ( decalColor , depth , vertex . position . z , 1.0f , accumTarget , coverageTarget ) ; 
