...
{ 
    float4 position : POSITION0 ; float4 blend_weights : BLENDWEIGHT0 ; uint4 blend_indices : BLENDINDICES0 ; 
} ; 
...
#line 126
    ...
    __position_object = unpack_position_and_scale ( input . position ) ; __blend_weights = input . blend_weights ; __blend_indices = input . blend_indices ; 
