...
{ 
    float gaussSum = GaussianWeight [ index + 10 ] + GaussianWeight [ index + 10 + 1 ] ; 
    float uvShift = 1 - GaussianWeight [ index + 10 ] / gaussSum ; 
...
{ 
    float gaussSum = GaussianWeight [ index + 10 ] ; 
...
{ 
    ...
    result = sample * GaussianWeight [ 10 ] ; 
