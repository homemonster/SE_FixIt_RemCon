...
{ 
    float gaussSum = GaussianWeight [ index + 6 ] + GaussianWeight [ index + 6 + 1 ] ; 
    float uvShift = 1 - GaussianWeight [ index + 6 ] / gaussSum ; 
...
{ 
    float gaussSum = GaussianWeight [ index + 6 ] ; 
...
{ 
    ...
    result = sample * GaussianWeight [ 6 ] ; 
